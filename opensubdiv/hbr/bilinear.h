...
template <class T> class HbrBilinearSubdivision : public HbrSubdivision<T>
{
  public:
    ...
    virtual HbrSubdivision<T> *Clone() const { return new HbrBilinearSubdivision<T>(); }
...
template <class T> void HbrBilinearSubdivision<T>::transferFVarToChild(HbrMesh<T> *mesh, HbrFace<T> *face, HbrFace<T> *child, int index)
{
...
template <class T> void HbrBilinearSubdivision<T>::transferEditsToChild(HbrFace<T> *face, HbrFace<T> *child, int index)
{
    // Hand down hole tag
...
template <class T> void HbrBilinearSubdivision<T>::Refine(HbrMesh<T> *mesh, HbrFace<T> *face)
{
...
template <class T> HbrFace<T> *HbrBilinearSubdivision<T>::RefineFaceAtVertex(HbrMesh<T> *mesh, HbrFace<T> *face, HbrVertex<T> *vertex)
{
#ifdef HBR_DEBUG
...
template <class T> void HbrBilinearSubdivision<T>::GuaranteeNeighbor(HbrMesh<T> *mesh, HbrHalfedge<T> *edge)
{
    if (edge->GetOpposite())
    {
        return;
...
template <class T> void HbrBilinearSubdivision<T>::GuaranteeNeighbors(HbrMesh<T> *mesh, HbrVertex<T> *vertex)
{
#ifdef HBR_DEBUG
...
template <class T> bool HbrBilinearSubdivision<T>::HasLimit(HbrMesh<T> *mesh, HbrFace<T> *face)
{
    if (face->IsHole())
        return false;
...
template <class T> bool HbrBilinearSubdivision<T>::HasLimit(HbrMesh<T> * /* mesh */, HbrHalfedge<T> * /* edge */) { return true; }

template <class T> bool HbrBilinearSubdivision<T>::HasLimit(HbrMesh<T> * /* mesh */, HbrVertex<T> *vertex)
{
...
template <class T> HbrVertex<T> *HbrBilinearSubdivision<T>::Subdivide(HbrMesh<T> *mesh, HbrFace<T> *face)
{
...
template <class T> HbrVertex<T> *HbrBilinearSubdivision<T>::Subdivide(HbrMesh<T> *mesh, HbrHalfedge<T> *edge)
{
#ifdef HBR_DEBUG
...
template <class T> HbrVertex<T> *HbrBilinearSubdivision<T>::Subdivide(HbrMesh<T> *mesh, HbrVertex<T> *vertex)
{
    HbrVertex<T> *v;
