...
template <class T> std::ostream &operator<<(std::ostream &out, const HbrVertexEdit<T> &path)
{
...
template <class T> class HbrVertexEdit : public HbrHierarchicalEdit<T>
{
  public:
    ...
    {
        if (HbrHierarchicalEdit<T>::GetNSubfaces() == face->GetDepth() && face->GetVertex(vertexid) == vertex)
        {
    ...
    virtual void ApplyToBound(struct bbox &bbox, RtMatrix *mx) const
    {
        if (isP)
        {
            ...
            else if (op == HbrHierarchicalEdit<T>::Add || op == HbrHierarchicalEdit<T>::Subtract)
            {
  ...
  public:
    ...
    virtual void ApplyToBound(struct bbox &bbox, RtMatrix *mx) const
    {
        if (isP)
        {
            ...
            else if (op == HbrVertexEdit<T>::Add || op == HbrVertexEdit<T>::Subtract)
            {
