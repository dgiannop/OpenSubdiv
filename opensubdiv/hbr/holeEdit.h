...
template <class T> std::ostream &operator<<(std::ostream &out, const HbrHoleEdit<T> &path)
{
...
template <class T> class HbrHoleEdit : public HbrHierarchicalEdit<T>
{
  public:
    HbrHoleEdit(int _faceid, int _nsubfaces, unsigned char *_subfaces) : HbrHierarchicalEdit<T>(_faceid, _nsubfaces, _subfaces) {}

    HbrHoleEdit(int _faceid, int _nsubfaces, int *_subfaces) : HbrHierarchicalEdit<T>(_faceid, _nsubfaces, _subfaces) {}
