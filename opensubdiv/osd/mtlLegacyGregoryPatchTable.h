...
class MTLLegacyGregoryPatchTable : private NonCopyable<MTLLegacyGregoryPatchTable>
{
  public:
    ~MTLLegacyGregoryPatchTable();

    template <typename DEVICE_CONTEXT> static MTLLegacyGregoryPatchTable *Create(Far::PatchTable const *farPatchTable, DEVICE_CONTEXT context) { return Create(farPatchTable, context); }
    ...
    id<MTLBuffer> GetVertexValenceBuffer() const { return _vertexValenceBuffer; }

    id<MTLBuffer> GetQuadOffsetsBuffer() const { return _quadOffsetsBuffer; }
