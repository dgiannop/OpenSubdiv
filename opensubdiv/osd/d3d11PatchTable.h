...
class D3D11PatchTable : private NonCopyable<D3D11PatchTable>
{
  public:
    ...
    template <typename DEVICE_CONTEXT> static D3D11PatchTable *Create(Far::PatchTable const *farPatchTable, DEVICE_CONTEXT context) { return Create(farPatchTable, context->GetDeviceContext()); }
    ...
    ID3D11Buffer *GetPatchIndexBuffer() const { return _indexBuffer; }

    /// Returns the SRV containing the patch parameter
    ID3D11ShaderResourceView *GetPatchParamSRV() const { return _patchParamBufferSRV; }
