...
CpuGLVertexBuffer::CpuGLVertexBuffer(int numElements, int numVertices) : _numElements(numElements), _numVertices(numVertices), _vbo(0), _cpuBuffer(0), _dataDirty(true)
{
...
CpuGLVertexBuffer *CpuGLVertexBuffer::Create(int numElements, int numVertices, void *)
{
...
void CpuGLVertexBuffer::UpdateData(const float *src, int startVertex, int numVertices, void * /*deviceContext*/)
{
