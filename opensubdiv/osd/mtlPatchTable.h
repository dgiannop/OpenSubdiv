...
class MTLPatchTable : private NonCopyable<MTLPatchTable>
{
  public:
    ...
    template <typename DEVICE_CONTEXT> static MTLPatchTable *Create(Far::PatchTable const *farPatchTable, DEVICE_CONTEXT context) { return Create(farPatchTable, context); }
