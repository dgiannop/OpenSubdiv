...
uint32_t Hash32(const void *data, size_t len) { return SpookyHash::Hash32(data, len, /*seed=*/0); }

uint32_t Hash32(const void *data, size_t len, uint32_t seed) { return SpookyHash::Hash32(data, len, seed); }

uint64_t Hash64(const void *data, size_t len) { return SpookyHash::Hash64(data, len, /*seed=*/0); }

uint64_t Hash64(const void *data, size_t len, uint64_t seed) { return SpookyHash::Hash64(data, len, seed); }
