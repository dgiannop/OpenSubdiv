...
inline PatchMap::QuadNode *PatchMap::assignLeafOrChildNode(QuadNode *node, bool isLeaf, int quadrant, int index)
{
...
//
PatchMap::PatchMap(PatchTable const &patchTable) : _minPatchFace(-1), _maxPatchFace(-1), _maxDepth(0)
{
