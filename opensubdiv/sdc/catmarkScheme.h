...
//  Catmark traits:
//
template <> inline Split Scheme<SCHEME_CATMARK>::GetTopologicalSplitType() { return SPLIT_TO_QUADS; }

template <> inline int Scheme<SCHEME_CATMARK>::GetRegularFaceSize() { return 4; }

template <> inline int Scheme<SCHEME_CATMARK>::GetRegularVertexValence() { return 4; }

template <> inline int Scheme<SCHEME_CATMARK>::GetLocalNeighborhoodSize() { return 1; }
...
//  this option.
//
template <> template <typename EDGE, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignSmoothMaskForEdge(EDGE const &edge, MASK &mask) const
{
...
//
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignCreaseMaskForVertex(VERTEX const &vertex, MASK &mask, int const creaseEnds[2]) const
{
    typedef typename MASK::Weight Weight;
...
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignSmoothMaskForVertex(VERTEX const &vertex, MASK &mask) const
{
    typedef typename MASK::Weight Weight;
...
//
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignCornerLimitMask(VERTEX const & /* vertex */, MASK &posMask) const
{
...
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignCreaseLimitMask(VERTEX const &vertex, MASK &posMask, int const creaseEnds[2]) const
{
    typedef typename MASK::Weight Weight;
...
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignSmoothLimitMask(VERTEX const &vertex, MASK &posMask) const
{
    typedef typename MASK::Weight Weight;
...
//  implementation
//
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignCornerLimitTangentMasks(VERTEX const &vertex, MASK &tan1Mask, MASK &tan2Mask) const
{
    int valence = vertex.GetNumEdges();
...
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignCreaseLimitTangentMasks(VERTEX const &vertex, MASK &tan1Mask, MASK &tan2Mask, int const creaseEnds[2]) const
{
    typedef typename MASK::Weight Weight;
...
template <> template <typename VERTEX, typename MASK> inline void Scheme<SCHEME_CATMARK>::assignSmoothLimitTangentMasks(VERTEX const &vertex, MASK &tan1Mask, MASK &tan2Mask) const
{
    typedef typename MASK::Weight Weight;
    ...
    else
    {
        ...
        double lambda = (5.0 / 16.0) + (1.0 / 16.0) * (cosTheta + cosHalfTheta * std::sqrt(2.0f * (9.0f + cosTheta)));
