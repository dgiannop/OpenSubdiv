...
struct ShapeDesc
{
    ShapeDesc(char const *iname, std::string const &idata, Scheme ischeme, bool iIsLeftHanded = false) : name(iname), data(idata), scheme(ischeme), isLeftHanded(iIsLeftHanded) {}
...
struct Shape
{
    ...
    static Shape *parseObj(char const *shapeString, Scheme shapeScheme, bool isLeftHanded = false, bool parsemtl = false);
