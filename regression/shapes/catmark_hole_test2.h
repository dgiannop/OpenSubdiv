...
static const std::string catmark_hole_test2 = "# This file uses centimeters as units for non-parametric coordinates.\n"
                                              "\n"
                                              "v -1.0000 -0.0000 -1.0000\n"
                                              "v -0.5000 -0.0000 -1.0000\n"
                                              "v 0.0000 -0.0000 -1.0000\n"
                                              "v 0.5000 -0.0000 -1.0000\n"
                                              "v 1.0000 -0.0000 -1.0000\n"
                                              "v -1.0000 -0.0000 -0.5000\n"
