...
int main(int, char **)
{
    ...
    int maxlevel = 2, nCoarseVerts = 0, nRefinedVerts = 0;
    ...
    Osd::CpuVertexBuffer *vbuffer = Osd::CpuVertexBuffer::Create(3, nCoarseVerts + nRefinedVerts);
    ...
    //
    {
        ...
        Osd::CpuEvaluator::EvalStencils(vbuffer, srcDesc, vbuffer, dstDesc, stencilTable);
    }
